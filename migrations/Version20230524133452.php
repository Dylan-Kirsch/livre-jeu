 ...
 */
final class Version20230524133452 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE partie (id INT AUTO_INCREMENT NOT NULL, aventure_id INT NOT NULL, aventurier_id INT NOT NULL, etape_id INT NOT NULL, date_partie DATETIME NOT NULL, INDEX IDX_59B1F3D873DBB5F (aventure_id), INDEX IDX_59B1F3DEDDC7141 (aventurier_id), INDEX IDX_59B1F3D4A8CA2AD (etape_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE personnage (id INT AUTO_INCREMENT NOT NULL, avatar_id INT NOT NULL, user_id INT DEFAULT NULL, prenom VARCHAR(255) NOT NULL, nom VARCHAR(255) NOT NULL, INDEX IDX_6AEA486D86383B10 (avatar_id), INDEX IDX_6AEA486DA76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
